<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PhongY1.ascx.cs" Inherits="Housing.YoKo.YoKoY1.PhongY1" %>
...
<%--<div class="filtr-item" data-category="3" data-sort="Busy streets">
    ...
    <a href="YokoY1/image/y1.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">

        <figure>
            <img src="YokoY1/image/y1.jpg" class="img-responsive" alt=" " />
...
<div class=" filtr-item" data-category="3" data-sort="Luminous night">
    <a href="YokoY1/image/y11.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">

        <figure>
            <img src="YokoY1/image/y11.jpg" class="img-responsive" alt=" " />
            <figcaption></figcaption>
        </figure>
    </a>
...
<div class="filtr-item" data-category="3" data-sort="In production">
    <a href="YokoY1/image/y111.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">

        <figure>

            <img src="YokoY1/image/y111.jpg" class="img-responsive" alt=" " />
            <figcaption>
                <h3></h3>
...
<div class=" filtr-item" data-category="3" data-sort="Industrial site">
    <a href="YokoY1/image/y1111.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">

        <figure>
            <img src="YokoY1/image/y1111.jpg" class="img-responsive" alt=" " />
            <figcaption>
                <h3></h3>
...
<div class=" filtr-item" data-category="3" data-sort="Industrial site">
    <a href="YokoY1/image/y111111.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">

        <figure>
            <img src="YokoY1/image/y111111.jpg" class="img-responsive" alt=" " />
            <figcaption>
                <h3></h3>
...
<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 900px; height: 900px; overflow: hidden; visibility: hidden;">
    ...
    <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 900px; height: 900px; overflow: hidden;">
        <div>
            <img  data-u="image" src="YokoY1/image/y1.jpg" alt=" " />
        </div>

        <div>
            <img data-u="image" src="YokoY1/image/y11.jpg" alt=" " />
        </div>
       
        <div>
            <img data-u="image" src="CommonImage/phongbep.jpg" alt=" " />
        </div>

        <div>
            <img data-u="image" src="YokoY1/image/y111.jpg" alt=" " />
        </div>

        <div>
            <img data-u="image" src="YokoY1/image/y1111.jpg" alt=" " />
        </div>

        <div>
            <img data-u="image" src="YokoY1/image/y111111.jpg" alt=" " />
        </div>

        <div>
            <img data-u="image" src="PhongVeSinh/y24.JPG" alt=" " />
        </div>

        <div>
            <img data-u="image" src="PhongVeSinh/y25.JPG" alt=" " />
        </div>

        <div>
            <img data-u="image" src="PhongVeSinh/y26.JPG" alt=" " />
        </div>
        <% for (int i = 1; i <= 54; i++)
   { %>
        <div>
