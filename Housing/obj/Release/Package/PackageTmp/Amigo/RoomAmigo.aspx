<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoomAmigo.aspx.cs" Inherits="Housing.Amigo.RoomAmigo" %>
...
<body id='photoseries' style="background-color: #F5FFF5">
    <div class='menu' style="text-align :center; background : rgb(124, 158, 74) !important; ">
        <a class='home-link' href='/'></a>
        <ul class='main-menu' >
            <li class='menu-section towns ' >
                <a class='menu-icon' href="/Amigo">
