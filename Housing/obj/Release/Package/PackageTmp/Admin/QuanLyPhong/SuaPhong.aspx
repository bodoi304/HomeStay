...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="panel-title">
                <asp:Label ID="lblTitle" runat="server" Text="Quản lý đặt phòng -> "></asp:Label><asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl ="~/Admin/QuanLyPhong/EDP.aspx">Sửa xóa đặt phòng trong hệ thống</asp:LinkButton> -> Sửa đặt phòng 
            </div>
    ...
    <div class="panel panel-widget forms-panel">
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                ...
                <div class="form-body">
                        <p style="margin-top: 15px"> <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" />
