<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="F2.ascx.cs" Inherits="Housing.Safa.F2.F2" %>
<%--    <% for(int i = 1; i <= 19; i++) { %> 
<div class=" filtr-item" data-category="3" data-sort="Industrial site">
    <a href='<%= "F2/image/" + i + ".JPG" %>' rel="title" class="b-link-stripe b-animate-go  thickbox" target="_blank">

        <figure>
            <img src='<%= "F2/image/" + i + ".JPG" %>' class="img-responsive" alt=" " />
...
<% for (int i = 1; i <= 19; i++)
            ...
            <div>
                ...
                <img data-u="image" src='<%= "F2/image/" + i + ".JPG" %>' />
