<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoomLaLa.aspx.cs" Inherits="Housing.LaLa.RoomLaLa" %>
...
<body id='photoseries' style="background-color: #F5FFF5">
    <div class='menu' style="text-align :center; background : rgb(139, 226, 241) !important; ">
        <a class='home-link' href='/'></a>
        <ul class='main-menu' >
            <li class='menu-section towns ' >
                <a class='menu-icon' href="/LaLa">
...
<%--        <ul class='right-menu'>
            ...
            <li class='collapsed-menu'>
                ...
                <div class='sub-menu'>
                    <ul>
                        <li>
                            <a href='/AnAn/ThongTinAnAn.aspx'>Hướng dẫn đến sapa
                            </a>
                        </li>
                         <li>
                            <a href='/AnAn/Cau_hoi_thuong_gapAnAn.aspx'>Câu hỏi thường gặp
                            </a>
                        </li>
                         <li>
                            <a href='/AnAn/Thuc_Don_AnAn.aspx'>Thực đơn Sapa
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class='dock'>
        ...
        <div class='dock-content'>
            ...
            <ul class='thumbnails' style='width: 9000px'>
                ...
                <% } %>
                  <% for (int i = 0; i < lstAnhChung.Count; i++)
                   { %>


                <li>
                    <div class='thumbnail'>
                        <span class='hover-info'><%= lstAnhChung[i].IMAGE_HOVER %>
                        </span>
                        <a href='javascript:;' rel='<%= i + 1 + lstAnh.Count %>'>

                            <img src='<%= lstAnhChung[i].IMAGE_THUMB_URL %>' width="86" height="86" />
                        </a>
                    </div>
    ...
    <div class='slider-holder'>
        <ul class='slideshow'>
            ...
            <li>
                ...
                <img src='<%= lstAnhChung[i].IMAGE_URL %>' />
            </li>
            <% } %>
        </ul>
    </div>
