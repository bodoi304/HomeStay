<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="S2.ascx.cs" Inherits="Housing.SamSam.S2.S2" %>
...
<% for (int i = 1; i <= 3; i++)
            ...
            <div>
                ...
                <img data-u="image" src='<%= "S2/image/" + i + ".JPG" %>' />
      ...
      <% for (int i = 1; i <= 35; i++)
                   { %>
            <div>
                    <img data-u="image" src='<%= "/SamSam/CommonImage/" + i + "-min.JPG" %>' />
