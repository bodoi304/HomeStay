<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPhong.Master" AutoEventWireup="true" CodeBehind="ManageUsersMain.aspx.cs" Inherits="ReportFinance.ManageUsers.ManageUsers.ManageUsersMain" %>
	...
	MasterGrid_EndCallback(s, e);
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Khóa/Mở khóa" ReadOnly="True"
                                            ...
                                            <DataItemTemplate>
                                                <asp:ImageButton ID="btnKhoaMoKhoa" runat="server" CommandArgument='' CommandName="cmdKhoa" ImageUrl="/Admin/images/icon/lock.png" />
                                                        ...
                                                        <dx:LayoutGroup Caption="TÀI KHOẢN" ColCount="2" GroupBoxDecoration="HeadingLine" Paddings-Padding="0" Paddings-PaddingTop="10">
                                                            ...
                                                            <Items>
                                                                ...
                                                                <dx:LayoutItem Caption="Xác nhận mật khẩu:">
                                                                  ...
                                                                  <dx:LayoutItem Caption="Quản lý nhà:">
                                                                    <LayoutItemNestedControlCollection>
                                                                        <dx:LayoutItemNestedControlContainer>
                                                                            <asp:CheckBoxList ID="ManageHome" runat="server" RepeatDirection="Horizontal">
                                                                                  <asp:ListItem Value="1">AnAn</asp:ListItem>
                                                                                ...
                                                                                <asp:ListItem Value="32">Mandara</asp:ListItem>
                                                                            </asp:CheckBoxList>
                                                                        </dx:LayoutItemNestedControlContainer>
                                                                    </LayoutItemNestedControlCollection>
                                                                </dx:LayoutItem>
