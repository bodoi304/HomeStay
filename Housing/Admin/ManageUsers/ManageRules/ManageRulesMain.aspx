<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPhong.Master" AutoEventWireup="true" CodeBehind="ManageRulesMain.aspx.cs" Inherits="ReportFinance.ManageUsers.ManageRules.ManageRulesMain" %>
                                ...
                                <asp:UpdateProgress runat="server" AssociatedUpdatePanelID="upUserRoleRule">
                                    <ProgressTemplate>
                                        <div class="center-screen">
                                            <img src="/Admin/images/icon/loading.gif" width="150" /></div>
