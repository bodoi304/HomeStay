        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4>   <asp:Button ID="btnThemPhong" runat="server" Text="Thêm Đặt Phòng" CssClass="btn btn-default" OnClick="btnThemPhong_Click"  ValidationGroup="them" />
                ...
                <div class="form-body">
                    <p style="margin-top: 15px">
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="them"/>
                        <p>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCheckin" data-mask="00/00/0000" data-mask-selectonfocus="true" Style="color: black !important" runat="server" placeholder="check-In dd/mm/yyyy" CssClass="date form-control datepicker" ></asp:TextBox>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Ngày check in bắt buộc phải nhập" ControlToValidate="txtCheckin" ForeColor="Red" Display="None"  ValidationGroup="them"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCheckout" data-mask="00/00/0000" data-mask-selectonfocus="true" Style="color: black !important" runat="server" placeholder="check-Out dd/mm/yyyy" CssClass="date form-control datepicker" ></asp:TextBox>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Ngày check out bắt buộc phải nhập" ControlToValidate="txtCheckout" ForeColor="Red" Display="None"  ValidationGroup="them"></asp:RequiredFieldValidator>
                    </div>
                      <div class="form-group">
                        ...
                        <asp:TextBox ID="txtPhongDat" Style="color: black !important" runat="server" placeholder="Phòng đặt" CssClass=" form-control"></asp:TextBox>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Mã phòng đặt bắt buộc phải nhập" ControlToValidate="txtPhongDat" ForeColor="Red" Display="None"  ValidationGroup="them"></asp:RequiredFieldValidator>
                    </div>
                     <div class="form-group">
