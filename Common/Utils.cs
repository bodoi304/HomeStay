...
namespace Common
{
    public class Utils
    {
        public static ASPxGridView setDisplayGridView(ASPxGridView grd, Boolean isShowExpan,Boolean isShowFlitter)
        {
            ...
            grd.SettingsCommandButton.NewButton.Image.Url = "/Admin/images/icon/add-icon.png";
            ...
            grd.Settings.ShowFilterRow = isShowFlitter;
            if (isShowExpan)
            {          
                ...
                if (type1 == typeof(CheckBoxList))
                {
                    ...
                    foreach (ListItem item1 in cbl.Items)
                    {
                        if (item1.Selected)
                        {
                            ...
                            abc += Convert .ToInt32( item1.Value);
                        }
                    }
                    item.SetValue(obj, abc);
                }
            }
